...
public class TableModelListado extends AbstractTableModel<Producto> implements javax.swing.table.TableModel {

    public TableModelListado(int[] cols, List<Producto> rows) {
        super(cols, rows);
    }
